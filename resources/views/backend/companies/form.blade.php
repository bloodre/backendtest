            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div id="form-prefecture" class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-content">
                            <!--{{ Form::select('prefecture',$company->prefecture_id, array('placeholder' => ' ', 'class' => '', 'data-prompt-position' => 'bottomLeft:0,11')) }}
                        -->
                        </div>
                    </div>
                    ...
                    <div id="form-image" class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-content">
                            <!--{{ Form::file('image',$company->image, array('placeholder' => ' ', 'class' => 'form-control validate[required, minSize[6], maxSize[8]]', 'data-prompt-position' => 'bottomLeft:0,11')) }}
                            -->
                        </div>
                    </div>
                    @if($company->page_type != 'create')
